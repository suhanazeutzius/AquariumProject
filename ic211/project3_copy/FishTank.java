...
public class FishTank {
  ...
  */
  public static ArrayList<Creature> init(JFrame aq, Random r){
    ...
    //to initialize the aquarium, add one jellyfish, two sharks, one fish, and 5 jellyfish
    for(int i = 0; i<1; i++)
  ...
  */
  public static void addCreature(Random r, String s, JFrame aq){
    //for each creature, add the creature to the tank unless the user enters a negative health value
    //if a negative value is entered, tell user to set positive health
    try{
      if(s.equals("shark")){
        if(Integer.parseInt(sHealth.getText()) <= 0)
          sHealth.setText("set pos health");
        else
        ...
        if(Integer.parseInt(fHealth.getText()) <= 0)
          fHealth.setText("set pos health");
        else
        ...
        if(Integer.parseInt(jHealth.getText()) <= 0)
          jHealth.setText("set pos health");
        else
  ...
  */
  ...
  /*  @param Random r
      @param JFrame aq
      @return JPanel The panel on the left side of the window with all the controls of the fishtank
  */
  public static JPanel controlPanel(Random r, JFrame aq){
    ...
    fishStats.setPreferredSize(new Dimension(120, 140));
    ...
    jellyStats.setPreferredSize(new Dimension(120, 140));
    ...
    sharkStats.setPreferredSize(new Dimension(120, 140));
    ...
    selLabels.setPreferredSize(new Dimension(300, 140));
  ...
  public static void main(String[] args){
    ...
    aq.setPreferredSize(new Dimension(912, 467));
    ...
    JPanel scrollAndControl = new JPanel(null);
    scrollAndControl.setPreferredSize(new Dimension(300, 700));
    scrollAndControl.add(scroll);
    ...
    aq.add(scrollAndControl, BorderLayout.WEST);
