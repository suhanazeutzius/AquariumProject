    ...
    for(Creature c1 : allFish){
      ...
      for(Creature c2 : allFish2){
        ...
        if(!r1.equals(r2) && r1.intersects(r2) && c1.hasHealth() && c2.hasHealth()){
          ...
          else if(c1.getName().equals("jellyfish") &&
                 (c2.getName().equals("fish") || c2.getName().equals("shark"))){
            if(c1.sting(c2)){
              c2.die();
              c2.updateStats();
            }
          }
          else if(c2.getName().equals("jellyfish") &&
                 (c1.getName().equals("fish") || c1.getName().equals("shark"))){
            if(c2.sting(c1)){
              c1.die();
              c1.updateStats();
            }
          }
          //shark eats fish or jellyfish
